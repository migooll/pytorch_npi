...
def test_standard(stdscr, npi_model: NPI, npi_task, num: int, result_logger: ResultLogger):
    ...
    questions = npi_task.lib.create_questions(num, max_number=10000)
    if DEBUG_MODE:
...
if __name__ == '__main__':
    ...
    task = "sort"
    npi_task = Task.init_task(task, sequential=False)

    # model_path_ = sys.argv[1]
    model_path = "./lightning_logs/version_5/checkpoints/epoch=0-step=909.ckpt"
